...
/**
 * Bar panel for PacketeryTracy 2.x
 */
class PacketeryLattePanel implements PacketeryTracy\IBarPanel
{
	...
	public static function initialize(Engine $latte, string $name = null, PacketeryTracy\Bar $bar = null): void
	{
		$bar = $bar ?? PacketeryTracy\Debugger::getBar();
