...
abstract class Component implements IComponent
{
	...
	final public function lookup(?string $type, bool $throw = true): ?IComponent
	{
		...
		if ($throw && $this->monitors[$type][0] === null) {
			...
			throw new PacketeryNette\InvalidStateException($message);
		}
	...
	public function setParent(?IContainer $parent, string $name = null)
	{
		...
		if ($this->parent !== null && $parent !== null) {
			throw new PacketeryNette\InvalidStateException("Component '$this->name' already has a parent.");
		}
	 ...
	 * override this method to disallow a parent change by throwing an PacketeryNette\InvalidStateException
	 * @throws PacketeryNette\InvalidStateException
	 */
	...
	{
		throw new PacketeryNette\NotImplementedException('Object serialization is not supported by class ' . get_class($this));
	}
	...
	{
		throw new PacketeryNette\NotImplementedException('Object unserialization is not supported by class ' . get_class($this));
	}
}
