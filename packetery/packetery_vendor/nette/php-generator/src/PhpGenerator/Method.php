...
final class Method
{
	...
	{
		return (new Factory)->fromMethodReflection(PacketeryNette\Utils\Callback::toReflection($method));
	}
	...
	public function validate(): void
	{
		if ($this->abstract && ($this->final || $this->visibility === ClassType::VISIBILITY_PRIVATE)) {
			throw new PacketeryNette\InvalidStateException('Method cannot be abstract and final or private.');
		}
	}
}
