...
final class Reflection
{
	 ...
	 * If the function has union type, it throws PacketeryNette\InvalidStateException.
	 */
	 ...
	 * If the parameter has union type, it throws PacketeryNette\InvalidStateException.
	 */
	 ...
	 * If the property has union type, it throws PacketeryNette\InvalidStateException.
	 */
	...
	private static function getType($reflection, ?\ReflectionType $type, bool $asArray = false)
	{
		if ($type === null) {
			...
			throw new PacketeryNette\InvalidStateException('The ' . self::toString($reflection) . ' is not expected to have a union type.');

		} else {
			throw new PacketeryNette\InvalidStateException('Unexpected type of ' . self::toString($reflection));
		}
	}
	...
	public static function toString(\Reflector $ref): string
	{
		if ($ref instanceof \ReflectionClass) {
			...
			throw new PacketeryNette\InvalidArgumentException;
		}
	}
	...
	public static function expandClassName(string $name, \ReflectionClass $context): string
	{
		...
		if (empty($name)) {
			throw new PacketeryNette\InvalidArgumentException('Class name must not be empty.');
	...
	public static function getUseStatements(\ReflectionClass $class): array
	{
		if ($class->isAnonymous()) {
			throw new PacketeryNette\NotImplementedException('Anonymous classes are not supported.');
		}
		static $cache = [];
