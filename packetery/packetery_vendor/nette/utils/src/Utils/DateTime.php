...
class DateTime extends \DateTime implements \JsonSerializable
{
	 ...
	 * @return static
	 * @throws PacketeryNette\InvalidArgumentException if the date and time are not valid.
	 */
	public static function fromParts(
		...
		if (
			...
			throw new PacketeryNette\InvalidArgumentException("Invalid date '$s'");
		}
		return new static($s);
	}
	...
	public static function createFromFormat($format, $time, $timezone = null)
	{
		if ($timezone === null) {
			...
			throw new PacketeryNette\InvalidArgumentException('Invalid timezone given');
		}
