...
class CheckboxList extends MultiChoiceControl
{
	...
	{
		$data = $this->getForm()->getHttpData(PacketeryNette\Forms\Form::DATA_TEXT, substr($this->getHtmlName(), 0, -2));
		$data = $data === null
			? $this->getHttpData(PacketeryNette\Forms\Form::DATA_TEXT)
			: explode(',', $data);
	...
	public function getControl(): Html
	{
		...
		return $this->container->setHtml(
			PacketeryNette\Forms\Helpers::createInputList(
