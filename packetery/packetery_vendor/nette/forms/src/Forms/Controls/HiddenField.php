...
class HiddenField extends BaseControl
{
	...
	public function __construct($persistentValue = null)
	{
		...
		if ($persistentValue !== null) {
			$this->unmonitor(PacketeryNette\Forms\Form::class);
	...
	public function setValue($value)
	{
		if ($value === null) {
			...
			throw new PacketeryNette\InvalidArgumentException(sprintf("Value must be scalar or null, %s given in field '%s'.", gettype($value), $this->name));
		}
