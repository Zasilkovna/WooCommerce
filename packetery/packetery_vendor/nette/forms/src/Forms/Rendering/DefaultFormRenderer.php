...
namespace PacketeryNette\Forms\Rendering;

use PacketeryNette;
use PacketeryNette\HtmlStringable;
 ...
 */
class DefaultFormRenderer implements PacketeryNette\Forms\FormRenderer
{
	 ...
	 */
	public function render(PacketeryNette\Forms\Form $form, string $mode = null): string
	{
		if ($this->form !== $form) {
			$this->form = $form;
		}
	...
	public function renderEnd(): string
	{
		...
		if (iterator_count($this->form->getComponents(true, PacketeryNette\Forms\Controls\TextInput::class)) < 2) {
	 ...
	 */
	public function renderErrors(PacketeryNette\Forms\Control $control = null, bool $own = true): string
	{
		$errors = $control
			? $control->getErrors()
	 ...
	 * @param  PacketeryNette\Forms\Container|PacketeryNette\Forms\ControlGroup  $parent
	 */
	public function renderControls($parent): string
	{
		if (!($parent instanceof PacketeryNette\Forms\Container || $parent instanceof PacketeryNette\Forms\ControlGroup)) {
			throw new PacketeryNette\InvalidArgumentException('Argument must be PacketeryNette\Forms\Container or PacketeryNette\Forms\ControlGroup instance.');
		}
	 ...
	 */
	public function renderPair(PacketeryNette\Forms\Control $control): string
	{
	 ...
	 * @param  PacketeryNette\Forms\Control[]  $controls
	 */
	public function renderPairMulti(array $controls): string
	{
		$s = [];
		foreach ($controls as $control) {
			if (!$control instanceof PacketeryNette\Forms\Control) {
				throw new PacketeryNette\InvalidArgumentException('Argument must be array of PacketeryNette\Forms\IControl instances.');
			}
			...
			if ($description instanceof HtmlStringable) {
				...
				if ($control instanceof PacketeryNette\Forms\Controls\BaseControl) {
	 ...
	 */
	public function renderLabel(PacketeryNette\Forms\Control $control): Html
	{
	 ...
	 */
	public function renderControl(PacketeryNette\Forms\Control $control): Html
	{
