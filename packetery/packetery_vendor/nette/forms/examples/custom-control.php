...
/**
 * PacketeryNette Forms custom control example.
 */
...
use PacketeryNette\Forms\Helpers;
use PacketeryNette\Utils\Html;


class DateInput extends PacketeryNette\Forms\Controls\BaseControl
{
	/** @var string */
	private $day = '';
	...
	public function setValue($value)
	{
		if ($value === null) {
			...
			$date = PacketeryNette\Utils\DateTime::from($value);
	...
	public static function validateDate(PacketeryNette\Forms\Control $control): bool
	{
...
<!DOCTYPE html>
<meta charset="utf-8">
<title>PacketeryNette Forms custom control example</title>
<link rel="stylesheet" media="screen" href="assets/style.css" />
<script src="https://nette.github.io/resources/js/3/netteForms.js"></script>

<h1>PacketeryNette Forms custom control example</h1>
