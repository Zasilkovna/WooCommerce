 ...
 */
final class PhpExtension extends PacketeryNette\DI\CompilerExtension
{
	public function getConfigSchema(): PacketeryNette\Schema\Schema
	{
		return PacketeryNette\Schema\Expect::arrayOf('scalar');
	}
	...
	public function loadConfiguration()
	{
		foreach ($this->getConfig() as $name => $value) {
			if ($value === null) {
				...
				throw new PacketeryNette\NotSupportedException('Required function ini_set() is disabled.');
			}
		}
	}
}
