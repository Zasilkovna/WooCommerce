...
namespace PacketeryGuzzleHttp\PacketeryPsr7;

use PacketeryPsr\Http\Message\RequestInterface;
use PacketeryPsr\Http\Message\ServerRequestInterface;
...
final class Utils
{
     ...
     * - `PacketeryPsr\Http\Message\StreamInterface`: Returns the value as-is.
