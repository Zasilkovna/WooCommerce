...
/**
 * PacketeryNette Forms & Bootstap v4 rendering example.
 */
...
function makeBootstrap4(Form $form): void
{
	...
	foreach ($form->getControls() as $control) {
		...
		if ($type === 'button') {
			...
			if ($control instanceof PacketeryNette\Forms\Controls\Checkbox) {
...
<!DOCTYPE html>
<meta charset="utf-8">
<title>PacketeryNette Forms & Bootstrap v4 rendering example</title>

<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css">

<div class="container">
	<h1>PacketeryNette Forms & Bootstrap v4 rendering example</h1>
