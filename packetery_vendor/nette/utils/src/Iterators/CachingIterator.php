...
namespace PacketeryNette\Iterators;
...
class CachingIterator extends \CachingIterator implements \Countable
{
	...
	public function __construct($iterator)
	{
		if (is_array($iterator) || $iterator instanceof \stdClass) {
			...
			throw new PacketeryNette\InvalidArgumentException(sprintf('Invalid argument passed to %s; array or Traversable expected, %s given.', self::class, is_object($iterator) ? get_class($iterator) : gettype($iterator)));
		}
	...
	public function count(): int
	{
		...
		if ($inner instanceof \Countable) {
			...
			throw new PacketeryNette\NotSupportedException('Iterator is not countable.');
		}
	}
