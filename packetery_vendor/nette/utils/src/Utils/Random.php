...
final class Random
{
	...
	public static function generate(int $length = 10, string $charlist = '0-9a-z'): string
	{
		...
		if ($length < 1) {
			throw new PacketeryNette\InvalidArgumentException('Length must be greater than zero.');
		} elseif ($chLen < 2) {
			throw new PacketeryNette\InvalidArgumentException('Character list must contain at least two chars.');
		}
