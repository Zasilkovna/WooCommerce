...
class Request implements IRequest
{
	...
	{
		$res = PacketeryNette\Utils\Arrays::get($this->files, $key, null);
		return $res instanceof FileUpload ? $res : null;
	}


	/**
	 * Returns tree of upload files in a normalized structure, with each leaf an instance of PacketeryNette\Http\FileUpload.
	 */
