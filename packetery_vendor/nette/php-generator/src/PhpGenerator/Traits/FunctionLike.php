...
use PacketeryNette;
use PacketeryNette\PhpGenerator\Dumper;
use PacketeryNette\PhpGenerator\Parameter;
...
trait FunctionLike
{
	...
	public function setParameters(array $val): self
	{
		...
		foreach ($val as $v) {
			if (!$v instanceof Parameter) {
				throw new PacketeryNette\InvalidArgumentException('Argument must be PacketeryNette\PhpGenerator\Parameter[].');
			}
	...
	/** @deprecated */
	public function setNamespace(PacketeryNette\PhpGenerator\PhpNamespace $val = null): self
	{
