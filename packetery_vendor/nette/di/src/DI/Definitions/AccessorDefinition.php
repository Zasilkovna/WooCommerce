...
final class AccessorDefinition extends Definition
{
	...
	public function setImplement(string $type)
	{
		...
		if (
			...
			throw new PacketeryNette\InvalidArgumentException("Service '{$this->getName()}': Interface $type must have just one non-static method get().");
		} elseif ($method->getNumberOfParameters()) {
			throw new PacketeryNette\InvalidArgumentException("Service '{$this->getName()}': Method $type::get() must have no parameters.");
		}
