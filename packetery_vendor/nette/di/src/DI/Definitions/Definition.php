...
abstract class Definition
{
	...
	{
		if ($this->name) {
			throw new PacketeryNette\InvalidStateException('Name already has been set.');
		}
		$this->name = $name;
		return $this;
	}
	...
	protected function setType(?string $type)
	{
		...
		if ($type === null) {
			...
			throw new PacketeryNette\InvalidArgumentException("Service '$this->name': Class or interface '$type' not found.");
		} else {
			$this->type = PacketeryNette\DI\Helpers::normalizeClass($type);
		}
		return $this;
	}
	...
	abstract public function resolveType(PacketeryNette\DI\Resolver $resolver): void;


	abstract public function complete(PacketeryNette\DI\Resolver $resolver): void;


	abstract public function generateMethod(PacketeryNette\PhpGenerator\Method $method, PacketeryNette\DI\PhpGenerator $generator): void;
	...
	/** @deprecated Use '$def instanceof PacketeryNette\DI\Definitions\ImportedDefinition' */
	...
	/** @deprecated Use PacketeryNette\DI\Definitions\FactoryDefinition or AccessorDefinition */
