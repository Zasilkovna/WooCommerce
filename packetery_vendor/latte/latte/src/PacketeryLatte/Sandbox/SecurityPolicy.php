...
namespace PacketeryLatte\Sandbox;
 ...
 * Default-deny policy.
 */
class SecurityPolicy implements PacketeryLatte\Policy
{
	...
	public static function createSafePolicy(): self
	{
		...
		$policy->allowMethods(PacketeryLatte\Runtime\CachingIterator::class, self::ALL);
		$policy->allowProperties(PacketeryLatte\Runtime\CachingIterator::class, self::ALL);
