...
use Packetery\GuzzleHttp\Handler\CurlHandler;
use Packetery\GuzzleHttp\Handler\CurlMultiHandler;
use Packetery\GuzzleHttp\Handler\Proxy;
use Packetery\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \Packetery\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
