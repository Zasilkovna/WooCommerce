...
abstract class CompilerExtension
{
    ...
    /** @var array|object */
    protected $config = [];
    /** @var \Packetery\Nette\PhpGenerator\Closure */
    protected $initialization;
    /** @return static */
    public function setCompiler(Compiler $compiler, string $name)
    {
        $this->initialization = new \Packetery\Nette\PhpGenerator\Closure();
    ...
    {
        return \is_object($this->config) ? \Packetery\Nette\Schema\Expect::from($this->config) : \Packetery\Nette\Schema\Expect::array();
    }
    /**
    ...
    public function getInitialization() : \Packetery\Nette\PhpGenerator\Closure
    {
