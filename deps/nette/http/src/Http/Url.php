...
class Url implements \JsonSerializable
{
     ...
     * @throws \Packetery\Nette\InvalidArgumentException if URL is malformed
     */
    public function __construct($url = null)
    {
        if (\is_string($url)) {
            ...
            if ($p === \false) {
                throw new \Packetery\Nette\InvalidArgumentException("Malformed or unsupported URI '{$url}'.");
            }
    ...
    /** @internal */
    public final function export() : array
    {
    ...
    private static function idnHostToUnicode(string $host) : string
    {
        ...
        \trigger_error('PHP extension intl is not loaded or is too old', \E_USER_WARNING);
    }
    /**
