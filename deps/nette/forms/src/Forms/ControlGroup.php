...
class ControlGroup
{
    ...
    public function add(...$items)
    {
        foreach ($items as $item) {
            if ($item instanceof Control) {
                ...
                throw new \Packetery\Nette\InvalidArgumentException("Control or Container items expected, {$type} given.");
            }
        }
        return $this;
    }
     ...
     * - 'label' - textual or \Packetery\Nette\HtmlStringable object label
     * - 'visual' - indicates visual group
     * - 'container' - container as Html object
     * - 'description' - textual or \Packetery\Nette\HtmlStringable object description
