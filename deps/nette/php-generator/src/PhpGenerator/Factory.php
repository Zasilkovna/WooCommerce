...
final class Factory
{
    ...
    public function fromClassReflection(\ReflectionClass $from, bool $withBodies = \false, bool $materializeTraits = \true) : ClassType
    {
        if ($withBodies && $from->isAnonymous()) {
            throw new \Packetery\Nette\NotSupportedException('The $withBodies parameter cannot be used for anonymous functions.');
        }
    ...
    public function fromFunctionReflection(\ReflectionFunction $from, bool $withBody = \false)
    {
        ...
        if ($withBody) {
            if ($from->isClosure()) {
                throw new \Packetery\Nette\NotSupportedException('The $withBody parameter cannot be used for closures.');
            }
    ...
    public function fromClassCode(string $code) : ClassType
    {
        ...
        if (!$classes) {
            throw new \Packetery\Nette\InvalidStateException('The code does not contain any class.');
        }
