...
class XsdTypesParserSpec extends ObjectBehavior
{
    ...
    function it_can_parse_ext_soap_types_strings_with_single_argument(XsdTypeVisitorInterface $visitor1, XsdTypeVisitorInterface $visitor2)
    {
        $abusedClient = $this->mockAbusedClient([$typeString1 = 'string simpleType1', $typeString2 = 'string simpleType2', $typeString3 = 'struct invalid xsdtype {}']);
    ...
    function it_contains_a_default_set_of_visitors()
    {
        ...
        $abusedClient = $this->mockAbusedClient([$unionString1 = 'union unionType {member1,member2}', $unionString2 = 'union unionType', $listString1 = 'list listType {member1,member2}', $listString2 = 'list listType', $simpleTypeString = 'string simpleType', $structString = 'struct invalid xsdtype {}']);
        $result = $this->parse($abusedClient);
    ...
    {
        $this->beConstructedThrough('default', []);
        $abusedClient = $this->mockAbusedClient([$typeString1 = 'string simpleType', $typeString2 = 'integer simpleType']);
        $result = $this->parse($abusedClient);
        $result->shouldHaveCount(2);
        $iterator = $result->getIterator();
