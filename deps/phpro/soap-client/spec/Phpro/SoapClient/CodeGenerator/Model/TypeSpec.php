...
class TypeSpec extends ObjectBehavior
{
    function let()
    {
        $this->beConstructedWith($namespace = 'MyNamespace', 'myType', [new Property('prop1', 'string', $namespace)]);
    }
    ...
    {
        $this->getFullName()->shouldReturn('Packetery\\MyNamespace\\MyType');
    }
    ...
    {
        $this->beConstructedWith($namespace = 'MyNamespace', 'Final', [new Property('xor', 'string', $namespace)]);
