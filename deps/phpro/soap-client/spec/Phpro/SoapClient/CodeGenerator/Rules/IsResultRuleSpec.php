...
use Packetery\Phpro\SoapClient\CodeGenerator\Rules\IsResultRule;
...
class IsResultRuleSpec extends ObjectBehavior
{
    ...
    {
        $metadata->getMethods()->willReturn(new MethodCollection(new Method('method1', [new Parameter('prop1', XsdType::create('string'))], XsdType::create('Result-Type'))));
