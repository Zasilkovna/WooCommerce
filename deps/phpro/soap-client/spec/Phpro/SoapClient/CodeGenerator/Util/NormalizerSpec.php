...
class NormalizerSpec extends ObjectBehavior
{
    ...
    function it_can_normalize_namespace()
    {
        ...
        $this->normalizeNamespace('NameSpace\\')->shouldReturn('NameSpace');
        $this->normalizeNamespace('\\NameSpace\\')->shouldReturn('NameSpace');
        $this->normalizeNamespace('Name/Space')->shouldReturn('Packetery\\Name\\Space');
    }
    ...
    {
        $this->normalizeClassnameInFQN('Packetery\\ns1\\myType')->shouldReturn('Packetery\\ns1\\MyType');
        $this->normalizeClassnameInFQN('Packetery\\ns1\\final')->shouldReturn('Packetery\\ns1\\FinalType');
        $this->normalizeClassnameInFQN('Packetery\\ns1\\Final')->shouldReturn('Packetery\\ns1\\FinalType');
        $this->normalizeClassnameInFQN('Packetery\\ns1\\UpperCased')->shouldReturn('Packetery\\ns1\\UpperCased');
        $this->normalizeClassnameInFQN('ns1\\my-./*type_123')->shouldReturn('Packetery\\ns1\\MyType123');
        $this->normalizeClassnameInFQN('ns1\\my-./final*type_123')->shouldReturn('Packetery\\ns1\\MyFinalType123');
    ...
    function it_gets_classname_from_fqn()
    {
        ...
        $this->getClassNameFromFQN('Packetery\\Namespace\\MyClass')->shouldReturn('MyClass');
        $this->getClassNameFromFQN('Packetery\\Vendor\\Namespace\\MyClass')->shouldReturn('MyClass');
    }
    function it_gets_complete_use_statement()
    {
        $this->getCompleteUseStatement('Packetery\\Namespace\\MyClass', 'ClassAlias')->shouldReturn('Namespace\\MyClass as ClassAlias');
        $this->getCompleteUseStatement('Packetery\\Namespace\\MyClass', null)->shouldReturn('Packetery\\Namespace\\MyClass');
