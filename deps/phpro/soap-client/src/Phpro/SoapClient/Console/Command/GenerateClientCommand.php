...
class GenerateClientCommand extends Command
{
    ...
    {
        $this->setName(self::COMMAND_NAME)->setDescription('Generates a client based on WSDL.')->addOption('config', null, InputOption::VALUE_REQUIRED, 'The location of the soap code-generator config file')->addOption('overwrite', 'o', InputOption::VALUE_NONE, 'Makes it possible to overwrite by default');
    }
    /**
     * {@inheritdoc}
     */
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $methodMap = ClientMethodMap::fromMetadata($config->getTypeNamespace(), $config->getEngine()->getMetadata()->getMethods());
        ...
        $this->generateClient($fileGenerator, $generator, $client, $destination);
