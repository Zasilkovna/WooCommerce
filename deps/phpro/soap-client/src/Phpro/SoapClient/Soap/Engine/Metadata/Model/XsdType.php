...
class XsdType
{
    ...
    {
        return self::create($name)->withBaseType(self::convertBaseType($name, ''));
    }
    public static function fetchAllKnownBaseTypeMappings() : array
    {
        return ['anyuri' => 'string', 'base64binary' => 'string', 'byte' => 'integer', 'decimal' => 'float', 'double' => 'float', 'duration' => 'string', 'entities' => 'string', 'entity' => 'string', 'gday' => 'string', 'gmonth' => 'string', 'gmonthday' => 'string', 'gyear' => 'string', 'gyearmonth' => 'string', 'hexbinary' => 'string', 'id' => 'string', 'idref' => 'string', 'idrefs' => 'string', 'int' => 'integer', 'language' => 'string', 'long' => 'integer', 'map' => 'array', 'name' => 'string', 'ncname' => 'string', 'ncnames' => 'string', 'negativeinteger' => 'integer', 'nmtoken' => 'string', 'nmtokens' => 'string', 'nonnegativeinteger' => 'integer', 'nonpositiveinteger' => 'integer', 'normalizedstring' => 'string', 'notation' => 'string', 'positiveinteger' => 'integer', 'qname' => 'string', 'short' => 'integer', 'struct' => 'object', 'time' => 'string', 'timeinstant' => 'string', 'token' => 'string', 'unknown' => 'anyType', 'unsignedbyte' => 'integer', 'unsignedint' => 'integer', 'unsignedlong' => 'integer', 'unsignedshort' => 'integer'];
    }
