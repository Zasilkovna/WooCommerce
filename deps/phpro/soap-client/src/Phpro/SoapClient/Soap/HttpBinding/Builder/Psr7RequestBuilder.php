...
namespace Packetery\Phpro\SoapClient\Soap\HttpBinding\Builder;
...
class Psr7RequestBuilder
{
    ...
    public function getHttpRequest() : RequestInterface
    {
        $this->validate();
        try {
            $request = $this->messageFactory->createRequest($this->httpMethod, $this->endpoint)->withBody($this->prepareMessage());
