...
namespace Packetery\Phpro\SoapClient\Soap\HttpBinding;
...
class LastRequestInfo
{
     ...
     */
    public function __construct(string $lastRequestHeaders, string $lastRequest, string $lastResponseHeaders, string $lastResponse)
    {
