...
use Packetery\Phpro\SoapClient\Soap\Engine\Metadata\Model\Property as MetadataProperty;
use Packetery\Phpro\SoapClient\Soap\Engine\Metadata\Model\Type as MetadataType;
use SplFileInfo;
/**
 * Class Type
 *
...
class Type
{
    ...
    {
        return new self($namespace, $type->getName(), \array_map(function (MetadataProperty $property) use($namespace) {
            return Property::fromMetaData($namespace, $property);
        }, $type->getProperties()));
    }
    /**
     * @return string
