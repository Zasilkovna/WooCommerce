...
use Packetery\RobRichards\WsePhp\WSSESoap;
...
class WsseMiddleware extends Middleware
{
     ...
     * @var bool
     */
    private $serverCertificateHasSubjectKeyIdentifier = \true;
    ...
    public function beforeRequest(callable $handler, RequestInterface $request) : Promise
    {
        ...
        $key->loadKey($this->privateKeyFile, \true);
        ...
        if ($this->encrypt) {
            ...
            $siteKey->loadKey($this->serverCertificateFile, \true, \true);
            $wsse->encryptSoapDoc($siteKey, $key, ['KeyInfo' => ['X509SubjectKeyIdentifier' => $this->serverCertificateHasSubjectKeyIdentifier]]);
        }
    ...
    public function afterResponse(ResponseInterface $response) : ResponseInterface
    {
        ...
        $wsse = new WSSESoap($xml->getXmlDocument());
        $wsse->decryptSoapDoc($xml->getXmlDocument(), ['keys' => ['private' => ['key' => $this->privateKeyFile, 'isFile' => \true, 'isCert' => \false]]]);
