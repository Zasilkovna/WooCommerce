...
class NtlmMiddleware extends Middleware
{
    ...
    {
        throw new RuntimeException('The NTLM middleware is deprecated since we moved from guzzle to httplug clients.' . \PHP_EOL . 'You need to configure NTLM on your HTTP client. This can be done with following curl options:' . \PHP_EOL . \PHP_EOL . 'CURLOPT_HTTPAUTH = CURLAUTH_NTLM' . \PHP_EOL . 'CURLOPT_USERPWD = "' . $this->username . ':' . $this->password . '"' . \PHP_EOL);
    }
}
