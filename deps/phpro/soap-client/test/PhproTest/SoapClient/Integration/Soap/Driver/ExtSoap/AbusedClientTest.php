...
class AbusedClientTest extends TestCase
{
    ...
    {
        $this->configureForWsdl(FIXTURE_DIR . '/wsdl/functional/string.wsdl', ['typemap' => $this->generateHelloTypeMap('string')]);
...
EORESPONSE;
    ...
    {
        return [['type_name' => $xsdType, 'type_ns' => 'http://www.w3.org/2001/XMLSchema', 'from_xml' => function () {
            return 'hello';
        }, 'to_xml' => function () {
            return '<d>hello</d>';
        }]];
