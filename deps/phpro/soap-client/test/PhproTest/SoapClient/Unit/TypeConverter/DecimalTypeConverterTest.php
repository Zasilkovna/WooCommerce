...
namespace Packetery\PhproTest\SoapClient\Unit\TypeConverter;

use Packetery\Phpro\SoapClient\Soap\TypeConverter\DecimalTypeConverter;
...
class DecimalTypeConverterTest extends TestCase
{
    ...
    public function testConvertPhpToXml()
    {
        ...
        $output = $this->converter->convertPhpToXml((float) 24.7);
