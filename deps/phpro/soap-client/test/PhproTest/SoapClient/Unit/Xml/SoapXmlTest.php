...
class SoapXmlTest extends TestCase
{
    ...
    function it_knows_the_soap_namespace_uri()
    {
        ...
        $this->assertEquals('http://www.w3.org/2003/05/soap-envelope/', $xml->getSoapNamespaceUri());
    }
    /**
     * @test
     */
    function it_is_possible_to_register_an_xpath_namespace()
    {
        ...
        $this->assertEquals($xml->xpath('/s:Envelope')->item(0), $this->xml->documentElement);
    }
    /**
     * @test
     */
    ...
    {
        $xml = new SoapXml($this->xml);
        $this->assertEquals($xml->xpath('/soap:Envelope')->item(0), $this->xml->documentElement);
    }
    /**
     * @test
     */
