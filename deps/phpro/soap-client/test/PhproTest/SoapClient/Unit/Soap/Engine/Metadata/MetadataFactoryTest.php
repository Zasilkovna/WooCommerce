...
class MetadataFactoryTest extends TestCase
{
    ...
    private function createHardCodedManipulatorOptions(MethodCollection $expectedMethods, TypeCollection $expectedTypes)
    {
        return MetadataOptions::empty()->withTypesManipulator(new class($expectedTypes) implements TypesManipulatorInterface
        {
            /**
             * @var TypeCollection
             */
