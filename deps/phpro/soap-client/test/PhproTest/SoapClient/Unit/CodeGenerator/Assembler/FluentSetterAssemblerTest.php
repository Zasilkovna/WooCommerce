...
use Packetery\Phpro\SoapClient\CodeGenerator\Assembler\FluentSetterAssembler;
use Packetery\Phpro\SoapClient\CodeGenerator\Assembler\FluentSetterAssemblerOptions;
...
CODE;
    ...
    private function createContext()
    {
        ...
        $type = new Type($namespace = 'MyNamespace', 'MyType', [$property = new Property('prop1', 'string', 'ns1')]);
    ...
    {
        $class = new ClassGenerator('MyType', 'MyNamespace');
        $type = new Type($namespace = 'MyNamespace', 'MyType', [$property = new Property('prop1', 'foobar', $namespace)]);
        return new PropertyContext($class, $type, $property);
    }
    /**
     * @return PropertyContext
