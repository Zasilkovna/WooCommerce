...
use Packetery\Phpro\SoapClient\CodeGenerator\Assembler\GetterAssembler;
use Packetery\Phpro\SoapClient\CodeGenerator\Assembler\GetterAssemblerOptions;
...
CODE;
    ...
    {
        $options = (new GetterAssemblerOptions())->withDocBlocks(\false);
        $assembler = new GetterAssembler($options);
        $context = $this->createContext('prop2');
        $assembler->assemble($context);
        $code = $context->getClass()->generate();
...
CODE;
    ...
    {
        $properties = ['prop1' => new Property('prop1', 'string', 'ns1'), 'prop2' => new Property('prop2', 'int', 'ns1'), 'prop3' => new Property('prop3', 'boolean', 'ns1'), 'prop4' => new Property('prop4', 'My_Response', 'ns1')];
