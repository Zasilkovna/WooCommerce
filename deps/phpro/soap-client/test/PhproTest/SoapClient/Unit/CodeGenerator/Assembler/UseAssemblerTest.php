...
use Packetery\Phpro\SoapClient\CodeGenerator\Assembler\UseAssembler;
...
CODE;
    ...
    {
        $assembler = new UseAssembler('Packetery\\MyNamespace\\SomeOtherClass');
        $context = $this->createContext();
        $assembler->assemble($context);
        $code = $context->getClass()->generate();
        $expected = <<<CODE
...
CODE;
    ...
    {
        $assembler = new UseAssembler('Packetery\\DifferentNamespace\\SomeOtherClass');
        $context = $this->createContext();
        $assembler->assemble($context);
        $code = $context->getClass()->generate();
        $expected = <<<CODE
