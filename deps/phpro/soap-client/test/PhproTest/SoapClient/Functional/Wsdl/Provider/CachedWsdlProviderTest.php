...
use Packetery\Phpro\SoapClient\Wsdl\Provider\CachedWsdlProvider;
...
use Packetery\Symfony\Component\Filesystem\Filesystem;
/** @internal */
class CachedWsdlProviderTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->wsdlProvider = new CachedWsdlProvider($this->loader->reveal(), $this->filesystem, $this->targetDir = \sys_get_temp_dir() . \DIRECTORY_SEPARATOR . 'soap-test-' . \random_int(100, 999));
    }
