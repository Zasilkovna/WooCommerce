...
class Bridge
{
    ...
    {
        $blueScreen = \Packetery\Tracy\Debugger::getBlueScreen();
        if (!\class_exists(Latte\Bridges\Tracy\BlueScreenPanel::class)) {
            ...
            \Packetery\Tracy\Debugger::addSourceMapper([self::class, 'mapLatteSourceCode']);
        }
    ...
    public static function renderMemberAccessException(?\Throwable $e) : ?array
    {
        ...
        $loc = \Packetery\Tracy\Debugger::mapSource($loc['file'], $loc['line']) ?? $loc;
