 ...
 */
namespace Packetery\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'Packetery\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'Packetery\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'Packetery\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'Packetery\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'Packetery\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'Packetery\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
