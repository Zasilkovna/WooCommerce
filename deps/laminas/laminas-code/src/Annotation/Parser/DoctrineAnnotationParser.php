 ...
 */
namespace Packetery\Laminas\Code\Annotation\Parser;

use Packetery\Doctrine\Common\Annotations\AnnotationRegistry;
use Packetery\Doctrine\Common\Annotations\DocParser;
use Packetery\Laminas\Code\Exception;
use Packetery\Laminas\EventManager\EventInterface;
use Traversable;
...
class DoctrineAnnotationParser implements ParserInterface
{
    ...
    {
        $this->allowedAnnotations[$annotation] = \true;
        return $this;
    }
    /**
