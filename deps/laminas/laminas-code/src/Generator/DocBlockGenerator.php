...
use Packetery\Laminas\Code\Generator\DocBlock\Tag;
use Packetery\Laminas\Code\Generator\DocBlock\Tag\TagInterface;
use Packetery\Laminas\Code\Generator\DocBlock\TagManager;
use Packetery\Laminas\Code\Reflection\DocBlockReflection;
...
class DocBlockGenerator extends AbstractGenerator
{
    ...
    protected function docCommentize($content)
    {
        ...
        $content = $this->getWordWrap() == \true ? wordwrap($content, 80, self::LINE_FEED) : $content;
