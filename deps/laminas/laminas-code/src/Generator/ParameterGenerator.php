...
use Packetery\Laminas\Code\Reflection\ParameterReflection;
...
class ParameterGenerator extends AbstractGenerator
{
     ...
     * @return ParameterGenerator
     */
    public function omitDefaultValue(bool $omit = \true)
    {
