...
use Packetery\Laminas\Code\Generator\Exception\InvalidArgumentException;
...
final class TypeGenerator implements GeneratorInterface
{
    ...
    {
        return in_array(strtolower($type), self::$internalPhpTypes, \true);
    }
}
