...
class Checkout {
	...
	public function calculateFees(): void {
		...
		if (
			...
			$feeAmount = $this->currencySwitcherFacade->getConvertedPrice( $carrierOptions->getAgeVerificationFee(), false );
		...
		$applicableSurcharge = $this->currencySwitcherFacade->getConvertedPrice( $applicableSurcharge, false );
