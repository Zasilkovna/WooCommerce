...
class Upgrade {
	...
	private function migrateWpOrderMetadata(): void {
		...
		if ( false === $createResult ) {
			...
			$this->messageManager->flash_message( __( 'Order table was not created, you can find more information in Packeta log', PACKETERY_LANG_DOMAIN ), MessageManager::TYPE_ERROR );
