		...
		if ( $countryIso ) {
			...
			$this->latteEngine->render(
				...
				[
					...
					'ageVerificationSupportedNotification' => __( 'When shipping via this carrier, you can order the Age Verification service. The service will get ordered automatically if there is at least 1 product in the order with the age verification setting.', 'packetery' ),
				]
			);
		} else {
