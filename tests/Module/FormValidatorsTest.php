...
class FormValidatorsTest extends TestCase {
	 ...
	 * @param array<string|float|int>   $validatorArgs
	 *
	 * @dataProvider validatorsDataProvider
	 */
	public function testValidators( callable $validator, array $validatorArgs, string|float|int $inputValue, bool $expected ): void {
		$input = new TextInput();
